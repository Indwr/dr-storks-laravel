...
mix.js('resources/assets/js/custom/custom.js',
    ...
    js('resources/assets/js/accounts/accounts_details_edit.js',
    ...
    js('resources/assets/js/bed_types/bed_types_details_edit.js',
        'public/assets/js/bed_types/bed_types_details_edit.js').
    js('resources/assets/js/beds/beds-details-edit.js',
        'public/assets/js/beds/beds-details-edit.js').
    js('resources/assets/js/document/document-details-edit.js',
        'public/assets/js/document/document-details-edit.js').
    js('resources/assets/js/document_type/doc_type-details-edit.js',
        'public/assets/js/document_type/doc_type-details-edit.js').
    js('resources/assets/js/doctors_departments/doctors_departments-details-edit.js',
        'public/assets/js/doctors_departments/doctors_departments-details-edit.js').
    js('resources/assets/js/birth_reports/create-details-edit.js',
        'public/assets/js/birth_reports/create-details-edit.js').
    js('resources/assets/js/death_reports/death_reports-details-edit.js',
