          ...
          <div class="row">
             <div class="col-lg-4 col-md-4">
                <div class="footer__logo">
                   <a href="#"><img src="img/xfooter-logo.png.pagespeed.ic.0wPASCKtKW.png" alt=""></a>
                </div>
             </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
             <div class="footer__address">
                ...
                <ul>
                   ...
                   <li><i class="fa fa-envelope"></i> <a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5f6d0d5d5cad7d1e5c2c8c4ccc98bc6cac8">[email&#160;protected]</a></li>
                </ul>
             </div>
          </div>
