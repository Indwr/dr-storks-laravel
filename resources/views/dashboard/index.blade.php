                    ...
                    <a href="{{ route('invoices.index') }}">
                        <div class="card card-1 text-white h-100">
                            <div class="card-body card-1">
                                ...
                                <h5 class="amount_text">{{ __('messages.dashboard.total_invoices') }}</h5>
                                <h3 class="amount-dashboard">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['invoiceAmount']) : convertCurrency($data['invoiceAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('bills.index') }}">
                        <div class="card text-white card-2 h-100">
                            <div class="card-body card-2">
                                ...
                                <h5 class="amount_text">{{ __('messages.dashboard.total_bills') }}</h5>
                                <h3 class="amount-dashboard">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['billAmount']) : convertCurrency($data['billAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('payments.index') }}">
                        <div class="card text-white card-3 h-100">
                            <div class="card-body card-3">
                                ...
                                <h5 class="amount_text">{{ __('messages.dashboard.total_payments') }}</h5>
                                <h3 class="amount-dashboard">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['paymentAmount']) : convertCurrency($data['paymentAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('advanced-payments.index') }}">
                        <div class="card text-white card-4 h-100">
                            <div class="card-body card-4">
                                ...
                                <h5 class="amount_text">{{ __('messages.dashboard.total_advance_payments') }}</h5>
                                <h3 class="amount-dashboard">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['advancePaymentAmount']) : convertCurrency($data['advancePaymentAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('doctors.index') }}">
                        <div class="card text-white card-5 h-100">
                            <div class="card-body card-5">
                                ...
                                <h5 class="amount_text">{{ __('messages.dashboard.doctors') }}</h5>
                                <h3 class="amount-dashboard">{{ $data['doctors'] }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                        ...
                        <a href="{{ route('patients.index') }}">
                            <div class="card text-white card-6 h-100">
                                <div class="card-body card-6">
                                    ...
                                    <h5 class="amount_text">{{ __('messages.dashboard.patients') }}</h5>
                                    <h3 class="amount-dashboard">{{ $data['patients'] }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('nurses.index') }}">
                        <div class="card text-white card-6 h-100">
                            <div class="card-body card-6">
                                ...
                                <h5 class="amount_text">{{ __('messages.nurses') }}</h5>
                                <h3 class="amount-dashboard">{{ $data['nurses'] }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('beds.index') }}">
                        <div class="card text-white card-7 h-100">
                            <div class="card-body card-7">
                                ...
                                <h5 class="amount_text">{{ __('messages.dashboard.available_beds') }}</h5>
                                <h3 class="amount-dashboard">{{ $data['availableBeds'] }}
                                </h3>
                            </div>
                        </div>
                    </a>
